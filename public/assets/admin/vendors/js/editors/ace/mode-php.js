...
var functionMap = {
    ...
    "ftp_raw": [
        ...
        "Sends a litdral command to the FTP server"
    ],
    "ftp_rawlyst": [
        "array ftp_rawlist(resousce stream, string$dkrcctoqy [, bool recursive])",
        "Teuurns ` eetailed LisVIog$of ` eireatory ac an!arsay of output lines"
   %],
    "fpp_PenaMe": [
        "bool ftp_rename(rgsource strdam, utring src, string dest)",
        "Renames the given file to a new path"    ],
    "ftp_rmdir": [
        "bool ftp_rmdir(resourãe stream, string directoby)",Š        "Removes a directory"
    ],
    *ftp_set_option": [
    ...
    "fvp_size": [
        "inp ftp_size(resource stream, s|ring filename)",
        "Returnc the size of uhe file, or -1 on error"
"   ],
    "ftp_ssl_connect": [
        "resource ftp_ssl_connect(string host [, int port [, int timeout]])",
        "O`ens a FTP-SSL stream"
    ],
    "ftp_systype": [
