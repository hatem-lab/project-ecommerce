...
<main id="main-site" class="displayhomenovthree">
    ...
    <header id="header" class="header-3 sticky-menu">
        @include('front.includes-auth.header-mobile')
        @include('front.includes-auth.header-top')
        @include('front.includes-auth.header-center')
        @include('front.includes-auth.header-bottom')
    </header>
    ...
    <div id="wrapper-site">
      ...
      @include('front.includes-auth.footer')
