...
@section('script')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCy_WwZRPLvcel7UsxRkSR7lAZKQDDUYck&libraries=places&callback=initAutocomplete&language=en&region=SYRIA
    async defer"></script>
@stop
