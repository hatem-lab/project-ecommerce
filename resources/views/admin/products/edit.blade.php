                                    ...
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.products.update',$product->id)}}"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="projectinput2"> اختر القسم الفرعي  </label>
                                                        ...
                                                        <optgroup label="من فضلك أختر القسم ">
                                                            ...
                                                            @if($subCategories && $subCategories -> count() > 0)
                                                                @foreach($subCategories as $category)
                                                                    <option
                                                                        value="{{$category -> id }}" {{ $product->subcategory_id==$category->id ?'selected' : ""}}>
                                                                        {{$category -> name}}</option>
                                                                @endforeach
                                                            @endif
                                                        </optgroup>
                                                ...
                                                @if($getLangouge -> count() > 0)
                                                    @foreach($getLangouge as $index => $lang)
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="projectinput1">  وصف المنتج - {{__('messages.'.$lang -> abbr)}} </label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{ $product->purchase_price }}" id="name"
                                                           class="form-control"
                                                           placeholder="  "
                                                           name="purchase_price">
                                            ...
                                            <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="projectinput1">   سعر المنيع  </label>
                                                <input type="text" value="{{ $product->sale_price }}" id="name"
                                                       class="form-control"
                                                       placeholder="  "
                                                       name="sale_price">
                                                @error("sale_price")
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{ $product->stock }}" id="name"
                                                           class="form-control"
                                                           placeholder="  "
                                                           name="stock">
                                                    @error("stock")
