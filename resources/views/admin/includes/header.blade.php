        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">مرجبا
                  <span
                      class="user-name text-bold-700">  Hatem Hasan</span>
                </span>
                            <span class="avatar avatar-online">
                  <img  style="height: 35px;"  src="{{asset('assets/admin/images/portrait/small/apple-icon-60.png')}} alt="avatar"><i></i></span>
                        </a>
