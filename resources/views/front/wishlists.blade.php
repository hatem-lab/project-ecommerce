                                                        ...
                                                        <div class="product-buttons d-flex justify-content-center"
                                                             ...
                                                             <form
                                                                ...
                                                                <input type="hidden" name="id_product"
                                                                       value="{{$product -> id}}">
                                                                <a class="add-to-cart cart-addition" data-product-id="{{$product -> id}}" data-product-slug="{{$product -> name}}" href="#"
...
@section('scripts')
    <script>
        ...
        $(document).on('click', '.removeFromWishlist', function (e) {
            ...
            $.ajax({
                type: 'delete',
                url: "{{ URL::to('wishlist') }}/" + $(this).attr('data-product-id')  ,
                data: {
            ...
            $(document).on('click', '.cart-addition', function (e) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        'product_name' : $(this).attr('data-product-slug'),
                    },
                    success: function (data) {
                        if(data.card ){
                        $('.alert3-modal').css('display','block');
