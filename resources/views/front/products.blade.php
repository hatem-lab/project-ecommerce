                ...
                <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
                    ...
                    <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                        <a itemprop="item" href="36-mini-speaker.html">
                            ...
                            <span itemprop="name">{{$category1 -> name}}</span>
                            @endforeach
            ...
            <div id="content-wrapper" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <section id="main">
                    <div class="block-category hidden-sm-down">
                        <h1 class="h1">@foreach ($category  as $category1 )
                            <span itemprop="name">{{$category1 -> name}}</span>
                            @endforeach</h1>
                    </div>
                    <section id="products">
                        ...
                        <div id="categories-product">
                            <div id="js-product-list">
                                <div class="products product_list grid row" data-default-view="grid">
                                        ...
                                        @if($product->translation_lang==App::getLocale())
                                                        ...
                                                        <div class="product-buttons d-flex justify-content-center"
                                                            ...
                                                            <form
                                                                ...
                                                                <input type="hidden" name="id_product"
                                                                       value="{{$product -> id}}">
                                                                <a class="add-to-cart cart-addition" data-product-id="{{$product -> id}}" data-product-name="{{$product -> name}}" href="#"
...
<script>
    ...
    $(document).on('click', '.close', function () {
        ...
        $('.alert3-modal').css("display", "none");
        $('.alert4-modal').css("display", "none");
    });
    $.ajaxSetup({
        headers: {
   ...
   $(document).on('click', '.cart-addition', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data.card ){
                location.reload();
                alert('successfully added to card list')
               }
                else{

                    $('.alert4-modal').css('display','block');
