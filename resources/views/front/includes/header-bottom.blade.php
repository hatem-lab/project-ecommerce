                            ...
                            <div id="verticalmenu" class="verticalmenu" role="navigation">
                                <ul class="menu level1">
                                    ...
                                    @foreach($categories as $category)
                                        <li class="item  parent"><a href="{{route('category',$category -> name )}}" title="Laptops &amp; Accessories"><i
                                            ...
                                            @isset($category -> subCategories)
                                                ...
                                                <div class="dropdown-menu" style="width:222px">
                                                    <ul>
                                                        @foreach($category -> subCategories as $childern)
                                                        @if($childern->translation_lang==App::getLocale())
                                                            <li class="item ">
                                                            <li class="item  parent">
                                                                <a href="#"
                                                                   title="Laptop Thinkpad">{{$childern -> name}}</a>
                                                                @isset($childern -> subcategorychildren )
                                                                    <span class="show-sub fa-active-sub"></span>
                                                                    <div class="dropdown-menu">
                                                                        <ul>
                                                                            @foreach($childern -> subcategorychildren  as $_childern)
                                                                            @if($_childern->translation_lang==App::getLocale())
                                                                                <li class="item ">
                                                                                    <a href="#"
